...
Now we are going to load in three right whale datasets. (This data is all publicly available, but it required me to combine multiple, messy, sources as well as data requests from the North Atlantic Right Whale Consortium.) We'll load: 
