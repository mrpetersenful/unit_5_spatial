...
ais = read.csv("data/too_big_for_students/raw/AIS_UTM17_Jan2017_4GB/2017_v2/AIS_2017_01_Zone17.csv") #data/AIS_ASCII_by_UTM_Month/2017_v2/AIS_2017_01_Zone17.csv")
head(ais)
